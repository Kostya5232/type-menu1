...
import { TTwoWayHyperboloidOptions } from "../../../../modules/Math3D/figures/TwoWayHyperboloid";
import { Figure } from "../../../../modules/Math3D";
interface ITwoWayHyperboloidParamsProps extends IFigureParamsProps {
    getFigure: (a: string, b: TTwoWayHyperboloidOptions) => Figure;
    figureName: string;
}
const TwoWayHyperboloidParams: React.FC<ITwoWayHyperboloidParamsProps> = ({ getFigure, figureName, setScene }) => {
...
export default TwoWayHyperboloidParams;
