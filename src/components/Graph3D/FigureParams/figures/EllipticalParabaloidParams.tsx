...
import { TEllipticalParabaloidOptions } from "../../../../modules/Math3D/figures/EllipticalParabaloid";
import { Figure } from "../../../../modules/Math3D";

interface IEllipticalParabaloidParamsProps extends IFigureParamsProps {
    getFigure: (a: string, b: TEllipticalParabaloidOptions) => Figure;
    figureName: string;
}
const EllipticalParabaloidParams: React.FC<IEllipticalParabaloidParamsProps> = ({ getFigure, figureName, setScene }) => {
...
export default EllipticalParabaloidParams;
