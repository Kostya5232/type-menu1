...
import { TOneWayHyperboloidOptions } from "../../../../modules/Math3D/figures/OneWayHyperboloid";
interface IOneWayHyperboloidParamsProps extends IFigureParamsProps {
    getFigure: (a: string, b: TOneWayHyperboloidOptions) => Figure;
    figureName: string;
}
const OneWayHyperboloidParams: React.FC<IOneWayHyperboloidParamsProps> = ({ getFigure, figureName, setScene }) => {
    ...
    return (
        <div>
            ...
            <input ref={refC} onChange={onChange} defaultValue={10} />
            <br></br>
...
export default OneWayHyperboloidParams;
